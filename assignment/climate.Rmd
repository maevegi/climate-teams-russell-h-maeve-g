...
The data points have a margin of uncertainty of about 27 to 60 Gt at each measurement point. There is missing data from the years 2017 to June of 2018 due to the cessation of the initial GRACE mission. 
...
```{r}
ggplot(arctic_ice)+
geom_point(mapping=aes(x=year, y=extent))
